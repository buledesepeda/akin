                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <a href="index_admin.php" class="btn btn-danger" style="margin-left: auto;">x</a>
                            </div>
                ...
                <thead>
                    <tr>
                        ...
                        <th style="padding: 1px;">
                            <center>
                                <button type="button" id="add-btn" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add_data">
                                    Add data
                                </button>
                            </center>
                        </th>
